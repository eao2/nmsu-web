    ...
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6 bg-card border border-border rounded-xl p-6 dark:bg-zinc-900 dark:border-zinc-800">
        ...
        <div>
          ...
          {club.profileImage && (
            <img src={club.profileImage} alt="Current" className="w-20 h-20 rounded-full object-cover mb-2 border border-border dark:border-zinc-700" />
          )}
          <input
            type="file"
            accept="image/*"
        ...
        <div>
          ...
          {club.coverImage && (
            <img src={club.coverImage} alt="Current" className="w-full h-32 object-cover rounded-lg mb-2 border border-border dark:border-zinc-700" />
          )}
          <input
            type="file"
            accept="image/*"
        ...
        <div className="pt-6 border-t border-border dark:border-zinc-700">
          <button
            type="button"
